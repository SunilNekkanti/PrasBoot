...
public class HedisMeasureGroupSpecifications implements Specification<HedisMeasureGroup> {

	private String searchTerm;

	public HedisMeasureGroupSpecifications(String searchTerm) {
		super();
		this.searchTerm = searchTerm;
	}

	public Predicate toPredicate(Root<HedisMeasureGroup> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
