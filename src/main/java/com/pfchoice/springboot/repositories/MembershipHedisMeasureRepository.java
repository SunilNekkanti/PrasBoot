...
@Repository
public interface MembershipHedisMeasureRepository
		extends PagingAndSortingRepository<MembershipHedisMeasure, Integer>, JpaSpecificationExecutor<MembershipHedisMeasure> {
