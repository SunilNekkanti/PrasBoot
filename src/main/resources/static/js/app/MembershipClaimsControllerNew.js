...
app.controller('MembershipClaimsControllerNew',
    ['MembershipClaimsServiceNew','ProviderService',  'InsuranceService', 'RiskReconService', 'MedicalLossRatioService','$scope', '$compile','$state','$stateParams', '$filter' ,'$localStorage','DTOptionsBuilder', 'DTColumnBuilder', function(MembershipClaimsService, ProviderService,  InsuranceService, RiskReconService,MedicalLossRatioService, $scope,$compile,$state,$stateParams, $filter,$localStorage, DTOptionsBuilder, DTColumnBuilder) {
