        ...
        NewMedicalLossRatioService
          ...
          .then(
            function(result) {
                ...
                keys.forEach(function(key) {
                  ...
                  switch (key) {
                    case 'activityMonth':
                      ...
                      break;
                    case 'reportMonth':
                      rowTotals[key] = result.data.content[0]['reportMonth'];
                      break;
                    case 'mlr':
                      rowTotals[key] = (rowTotals['totalExp'] / rowTotals['funding'] * 100).toFixed(2);
                      break;
                    case 'qmlr':
                      rowTotals[key] = (rowTotals['totalExp'] / rowTotals['funding'] * 100).toFixed(2);
                      break;
                    default:
                      rowTotals[key] = keyTotal.toFixed(2);
                  }
              ...
              var summaryRecords = $filter('filter')(self.finalData, {
                reportMonth: self.selectedReportMonths[0]
              });
