...
SELECT    mc.mbr_claim_id, csv2BhClaim.claimline, csv2BhClaim.ReferralID clm_line_adj_seq_nbr, 
...
null cover, now() created_date, now() updated_date, :username created_by ,:username updated_by,'Y', :fileId,
 null mony, csv2BhClaim.drg, null drug_version
  ...
  LEFT JOIN membership_claims mc on  mc.claim_id_number= csv2BhClaim.ClaimNum   and csv2BhClaim.mbr_id =mc.mbr_id and  mc.ins_id=:insId and mc.prvdr_id=csv2BhClaim.prvdr_id and mc.report_month=:activityMonth
