			           ...
			           <div class="row">
			              <div class="col-sm-6">
			                <div class="form-group col-sm-12">
			                  ...
			                  <input type="text" ng-model="ctrl.insurance.contract.contractNBR" name="contractNumber" class="username form-control input-sm" placeholder="Enter Contract Number" required ng-minlength="5"/>
			                  <div class="has-error" ng-show="myForm.$dirty">
			                ...
			                <div class="form-group col-sm-12">
			                  ...
			                  <input type="text" ng-model="ctrl.insurance.contract.avgServiceFund" name="avgServiceFund" class="username form-control input-sm" placeholder="Enter ServiceFund" required ng-minlength="1"/>
			                  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
			              <div class="col-sm-6">
			                <div class="form-group col-sm-12">
			                  ...
			                  <div class="input-group date" id="startDate"  name="startDate" ng-model="ctrl.insurance.contract.startDate" date1-picker>
                     			 <input type="text" class="form-control netto-input" ng-model="ctrl.insurance.contract.startDate" date-picker-input>
			                ...
			                <div class="form-group col-sm-12">
			                  ...
			                  <div class="input-group date" id="startDate"  name="endDate" ng-model="ctrl.insurance.contract.endDate" date1-picker>
                     			 <input type="text" class="form-control netto-input" ng-model="ctrl.insurance.contract.endDate" date-picker-input>
                      				<span class="input-group-addon">
			           							<span class="glyphicon glyphicon-calendar"></span>
                      				</span>
                    			</div>
                 ...
                 <div class="row">
                         <div class="col-sm-6">
			                <div class="form-group col-sm-12">
			                  ...
			                  <input type="text" ng-model="ctrl.insurance.contract.pmpm" name="pmpm" class="username form-control input-sm" placeholder="Enter Contract Number" required ng-minlength="1"/>
			                  <div class="has-error" ng-show="myForm.$dirty">
